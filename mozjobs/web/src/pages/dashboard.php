...
<body>
<header class="header"><div class="wrap"><div class="brand">MozJobs Dashboard</div><nav class="nav"><a href="/jobs/index.php">Vagas</a><a href="/services/index.php">Serviços</a><a href="/chat.php">Chat</a><a href="/hub.php">Hub</a><a href="/admin.php">Admin</a><a href="/profile/profile.php">Perfil</a></nav></div></header>
