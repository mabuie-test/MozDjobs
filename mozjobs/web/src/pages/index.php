...
<head>
  ...
  <title>MozJobs - Encontre oportunidades</title>
...
<main class="container">
  <section class="hero">
    ...
    <div class="card">
      ...
      <div class="kpis">
        <div class="kpi"><strong>12K+</strong><span class="muted">Profissionais</span></div>
  ...
  <section class="card" style="margin-top:20px">
    <h2>Como funciona</h2>
    <div class="grid">
      <div><h4>1) Publicar</h4><p class="muted">Empresas criam vagas e clientes publicam necessidades.</p></div>
      <div><h4>2) Escolher</h4><p class="muted">Profissionais enviam propostas e portfólio.</p></div>
      <div><h4>3) Fechar</h4><p class="muted">Pagamento em escrow e entrega com proteção.</p></div>
